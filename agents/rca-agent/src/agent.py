    ...
    async def process_incident(self, incident: dict) -> None:
        ...
        rca_payload = {
            ...
            "rca_result": {
                ...
                "dependency_path": [service_name, root_cause_service]
                if root_cause_service != service_name
                else [service_name],
                "confidence_score": confidence_score,
                "risk_score": risk_score,
                "failure_mode": "resource_exhaustion"
                if "db" in root_cause_service
                ...
                "evidence": [
                    {
                        ...
                        "description": f"Traversed topology downstream of {service_name}. Detected downstream dependency {root_cause_service} is active."
                        if root_cause_service != service_name
                        else f"No active downstream anomalies detected for {service_name}.",
                    }
                ],
            },
